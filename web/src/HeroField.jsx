 ...
 * 一层缓慢漂移的暖色光雾 —— 实测周期约 40–65s(不是那种一眼就看出在循环的动效),
 * 叠在既有 .stage-glow 之上。光团刻意排在右下与上部,左下保持暗,以免吃掉白色正文的对比度。 */

// [cx, cy, r, rgb, phase, driftX, driftY, speed] —— 位置/半径都是画布比例,speed 单位 rad/s
const BLOBS = [
  [0.74, 0.80, 0.52, '212,205,135', 0.0, 0.075, 0.060, 0.156],
  [0.88, 0.52, 0.34, '201,120,86', 2.1, 0.060, 0.090, 0.114],
  [0.64, 0.26, 0.28, '232,196,152', 3.9, 0.085, 0.060, 0.093],
  [0.38, 0.90, 0.30, '147,88,64', 5.3, 0.060, 0.070, 0.132],
]
